...
Console.WriteLine("Hello to TaskApp3!");
...
{   // [123][456][78][90]    
    ...
    Console.WriteLine($"[main_tid: {Environment.CurrentManagedThreadId}]: [{start_i}:{end_i}]");
    ...
    Task task = Task.Run(() =>
    {
        ...
        {
            currSum += arr[j];
            Console.WriteLine($"[tid: {Environment.CurrentManagedThreadId}]: - [{j}:{end_i}]");
        }
